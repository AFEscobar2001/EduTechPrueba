...
public class PerfilServiceTest {
    ...
    void asignarPerfilYaAsignado() {
        ...
        usuario.setCorreo("correo@duocuc.cl");
        ...
        when(usuarioRepository.findById("correo@duocuc.cl")).thenReturn(Optional.of(usuario));
        when(perfilRepository.findById(1)).thenReturn(Optional.of(perfil));

        String resultado = perfilService.asignarPerfil("correo@duocuc.cl", 1);
    ...
    void asignarPerfilCorrectamente() {
        ...
        assertEquals("Perfil 'Administrador' asignado correctamente al usuario 'correo@duocuc.cl'.", resultado);
    }
