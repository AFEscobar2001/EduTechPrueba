...
public class UsuarioServiceTest {
    ...
    void listarUsuarios() {
        ...
        u2.setCorreo("pepito@example.com");
        ...
        assertTrue(correos.contains("pepito@example.com"));
    }
    ...
    void actualizarUsuario() {
        ...
        existente.setContrasena("viejaClave");
        existente.setEstado(true);

        Usuario actualizado = new Usuario();
        actualizado.setCorreo("ali.aranda@duocuc.cl");
        actualizado.setContrasena("nuevaClave123");
    ...
    void noTienePermisosParaEliminar() {
        String correoAEliminar = "usuario@duocuc.cl";
        String correoSolicitante = "solicitante@duocuc.cl";
    ...
    void eliminarUsuario() {
        String correoAEliminar = "usuario@duocuc.cl";
        String correoSolicitante = "admin@duocuc.cl";
